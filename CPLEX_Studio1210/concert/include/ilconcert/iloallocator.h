...
//  Stack Allocator
// --------------------------------------------------------------------------
// PVilim: it seems to be used only by IloModelEvaluator, i.e. only by OPL.
...
private:
	...
	IloInt  _lost;
        IloAllocationList* _allocationList; // When ILO_NO_MEMORY_MANAGER is defined it deallocates the memory at the end
